        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    origin_ip = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    tracking_number = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    reference_number = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    customer_id = table.Column<Guid>(type: "uuid", nullable: true),
                    origin_port = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    destination_port = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    weight_kg = table.Column<decimal>(type: "numeric(18,3)", nullable: false),
                    volume_cbm = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    ...
                    current_location = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_shipment_status_histories_shipments_shipment_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_shipment_status_histories_shipment_id_event_time_utc",
                table: "shipment_status_histories",
                columns: new[] { "shipment_id", "event_time_utc" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_shipments_estimated_arrival_utc_current_status",
                table: "shipments",
                columns: new[] { "estimated_arrival_utc", "current_status" });
